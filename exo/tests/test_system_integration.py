...
class TestSystemIntegration:
    ...
    def test_brave_search_integration(self):
        ...
        original_generate = system.pia._generate_direct_response
        system.pia._generate_direct_response = MagicMock(return_value="Here are the search results for 'python tutorials':\n\n1. **Python Tutorial**\n   Learn Python programming\n   [Link](https://example.com/python)\n\n")
        ...
        try:
            ...
            system.pia._generate_direct_response = original_generate
    ...
    def test_filesystem_integration(self):
        ...
        # Mock the _generate_direct_response method
        original_generate = system.pia._generate_direct_response
        system.pia._generate_direct_response = MagicMock(return_value="Contents of '/home/user':\n\n📄 test.txt (100 bytes)\n📁 docs")
